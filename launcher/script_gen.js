...
- コンテンツスライド narration: 口語体・短文畳み掛けスタイルで150文字以内。「〜なんだよ。」「で、ここがやばくて。」みたいにテンポよく。事実ベースで「へぇ」となる内容
- ending narration: 話題に即したオチの一言（30文字以内）。「やっぱ〇〇はやべぇわ」「これはエモすぎる」みたいな締め。チャンネル登録促しは不要

【コメント仕様（opening/ending以外の全スライドに必須）】
- 8個
- 形式: [{text:"日本語", source:"x"|"reddit"|"yahoo"}, ...]
- 素材の_commentsから面白いものを使う。英文は内容を踏まえた面白い日本語意訳（直訳NG）
- 不足時は視聴者が書きそうなリアルな反応を生成（source:"x"）
- 以下の視点を混ぜてバリエーションを出す：
  突っ込み「そこじゃないww」、驚き「ガチで？やばすぎ」、感情「エモすぎて鳥肌」、
  分析「でもこれって〇〇が原因では」、笑い「草」「ワロタ」、共感「わかるww」、
  懐疑「これは盛りすぎじゃね」、熱狂「神！！！」
- 1コメント20〜80文字。短いコメントも OK（「草」単体も）
- 無難な「すごいですね」系は禁止。鋭くてリアルな反応を
